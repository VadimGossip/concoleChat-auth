...
// Validate checks the field values on CreateAsyncRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreateAsyncRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateAsyncRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CreateAsyncRequestMultiError, or nil if none found.
func (m *CreateAsyncRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateAsyncRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateAsyncRequestValidationError{
					field:  "Info",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return CreateAsyncRequestValidationError{
				field:  "Info",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return CreateAsyncRequestMultiError(errors)
	}

	return nil
}

// CreateAsyncRequestMultiError is an error wrapping multiple validation errors
// returned by CreateAsyncRequest.ValidateAll() if the designated constraints
// aren't met.
type CreateAsyncRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateAsyncRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateAsyncRequestMultiError) AllErrors() []error { return m }

// CreateAsyncRequestValidationError is the validation error returned by
// CreateAsyncRequest.Validate if the designated constraints aren't met.
type CreateAsyncRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateAsyncRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateAsyncRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateAsyncRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateAsyncRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateAsyncRequestValidationError) ErrorName() string {
	return "CreateAsyncRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreateAsyncRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateAsyncRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateAsyncRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateAsyncRequestValidationError{}
